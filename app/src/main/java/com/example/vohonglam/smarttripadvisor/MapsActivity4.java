...
public class MapsActivity4 extends FragmentActivity {

    GoogleMap map;
    private Marker myMarker;
    Context activityContext;
    LatLng dest = new LatLng(10.8039646, 106.6984896);
        ...
        if (map == null) {
            ...
            if (map != null) {
                ...
                myMarker = map.addMarker(new MarkerOptions()
                        .position(dest)
                        .title("La Villa French")
                        .snippet("Restaurant - French"));
    ...
    private void showCustomDialogBox() {
        ...
        ((TextView) customDialog.findViewById(R.id.sd_textView1))
                .setText("La Villa French");
        ((TextView) customDialog.findViewById(R.id.textView6))
                .setText("14 Ngo Quang Huy, Thao Dien Ward, District 2, Ho Chi Minh City");
        ((TextView) customDialog.findViewById(R.id.textView7))
                .setText("This is one of the finest restaurants in the world. From the amuse-bouche at the beginning to the petit fours at the end, every thing that goes on every plate is seriously considered. The food is fabulous and the service is impeccable. Treat yourself. Go.");
