...
public class MapsActivity3 extends FragmentActivity {
    ...
    LatLng dest = new LatLng(10.7643457, 106.6486723);
        ...
        if (map == null) {
            ...
            if (map != null) {
                ...
                myMarker = map.addMarker(new MarkerOptions()
                        ...
                        .snippet("Five-star hotel in HCMC"));
    ...
    private void showCustomDialogBox() {
        ...
        ((TextView) customDialog.findViewById(R.id.sd_textView1))
                .setText("Hotel Nikko Saigon");
        ((TextView) customDialog.findViewById(R.id.textView6))
                .setText("235 Nguyen Van Cu Street, District 1, Ho Chi Minh City");
        ((TextView) customDialog.findViewById(R.id.textView7))
                .setText("Hotel Nikko Saigon is a modern, stylish with minimalist design five-star hotel nestled within Ho Chi Minh City's business district and tourist attractions. The hotel offers exceptional relaxation and convenience combined with warmth Japanese hospitality.");
