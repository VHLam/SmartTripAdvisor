...
public class MapsActivity2 extends FragmentActivity {
    ...
    LatLng dest = new LatLng(10.7879356, 106.6232359);
        ...
        if (map == null) {
            ...
            if (map != null) {
                ...
                myMarker = map.addMarker(new MarkerOptions()
                        .position(dest)
                        .title("Galaxy Tan Binh")
                        .snippet("Tan Binh District, HCMC"));
    ...
    private void showCustomDialogBox() {
        ...
        ((TextView) customDialog.findViewById(R.id.sd_textView1))
                .setText("Galaxy Tan Binh");
        ((TextView) customDialog.findViewById(R.id.textView6))
                .setText("246 Nguyen Hong Dao Street, Tan Binh District, HCMC");
        ((TextView) customDialog.findViewById(R.id.textView7))
                .setText("Watch high quality new movie with a friend or relative or dating with your girlfriend");
