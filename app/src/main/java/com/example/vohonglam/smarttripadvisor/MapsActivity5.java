...
public class MapsActivity5 extends FragmentActivity {
    ...
    LatLng dest = new LatLng(10.7711171, 106.6601651);
        ...
        if (map == null) {
            ...
            if (map != null) {
                ...
                myMarker = map.addMarker(new MarkerOptions()
                        .position(dest)
                        .title("H&D Tailor")
                        .snippet("New World Saigon Hotel, HCMC"));
    ...
    private void showCustomDialogBox() {
        ...
        ((TextView) customDialog.findViewById(R.id.textView6))
                .setText("6 Pham Hong Thai Street, Ben Thanh Ward, District 1, Ho Chi Minh City, Vietnam");
        ((TextView) customDialog.findViewById(R.id.textView7))
                .setText("I've worn the suit twice and gotten an embarrassing number of compliments each time. You are onto something when the CEO walks up to compliment your smart turn out.");
